...
if __name__ == "__main__":
    backend_file_paths = [(Paths.backendRootPath + os.path.sep + f,str(p)) for f,p in zip(['tree/app.py', 'webIdeXterm.py','webIdeXterm.py','webIdeXterm.py'],[5001,5002,5003,5004])]
